<div class="grid grid-cols-12 mt-4 container no-select">
    ...
    <div class="col-span-12 sm:col-span-6 flex items-center mt-2 mr-auto ml-auto sm:mr-0 sm:ml-auto">
        <a href="{{url('/')}}" class="hover:underline mx-3">Go back</a>
        <a href="{{route('support.contact')}}" class="hover:underline text-primary mx-3">Help me</a>
    </div>
</div>
