<x-policy>
    ...
    <div class="max-w-3xl mx-auto bg-white my-4 p-6 text-gray-800">
        ...
        <div class="text-sm text-primary">
            <a href="#1" class="hover:underline">1. INFORMATION WE COLLECT</a><br>
            <a href="#2" class="hover:underline">2. LOG DATA</a><br>
            <a href="#3" class="hover:underline">3. PERSONAL INFORMATION</a><br>
            <a href="#4" class="hover:underline">4. LEGITIMATE REASONS FOR PROCESSING YOUR PERSONAL INFORMATION</a><br>
            <a href="#5" class="hover:underline">5. COLLECTION AND USE OF INFORMATION</a><br>
            <a href="#6" class="hover:underline">6. SECURITY OF YOUR PERSONAL INFORMATION</a><br>
            <a href="#7" class="hover:underline">7. HOW LONG WE KEEP YOUR PERSONAL INFORMATION</a><br>
            <a href="#8" class="hover:underline">8. CHILDREN’S PRIVACY</a><br>
            <a href="#9" class="hover:underline">9. DISCLOSURE OF PERSONAL INFORMATION TO THIRD PARTIES</a><br>
            <a href="#10" class="hover:underline">10. INTERNATIONAL TRANSFERS OF PERSONAL INFORMATION</a><br>
            <a href="#11" class="hover:underline">11. YOUR RIGHTS AND CONTROLLING YOUR PERSONAL INFORMATION</a><br>
            <a href="#12" class="hover:underline">12. USE OF COOKIES</a><br>
            <a href="#13" class="hover:underline">13. LIMITS OF OUR POLICY</a><br>
            <a href="#14" class="hover:underline">14. CHANGES TO THIS POLICY</a><br>
            <a href="#15" class="hover:underline">15. CONTACT US</a><br>
        </div>
        <br>

        <h4 id="1">1. INFORMATION WE COLLECT</h4>
        <p>
        ...
        <h4 id="3">3. PERSONAL INFORMATION</h4>
        ...
        <h4 id="4">4. LEGITIMATE REASONS FOR PROCESSING YOUR PERSONAL INFORMATION</h4>
        <p>
        ...
        <h4 id="5">5. COLLECTION AND USE OF INFORMATION</h4>
        ...
        <p>Please be aware that we may combine information we collect about you with general information or research data we receive from other trusted sources. <br><br></p>


        <h4 id="6">6. SECURITY OF YOUR PERSONAL INFORMATION</h4>
        <p>
        ...
        <h4 id="7">7. HOW LONG WE KEEP YOUR PERSONAL INFORMATION</h4>
        <p>
        ...
        <h4 id="8">8. CHILDREN’S PRIVACY</h4>
        <p>
        ...
        <h4 id="9">9. DISCLOSURE OF PERSONAL INFORMATION TO THIRD PARTIES</h4>
        <p>We may disclose personal information to: </p>
        <ul>
            <li>a parent, subsidiary, or affiliate of our company</li>
            <li>third party service providers for the purpose of enabling them to provide their services, for example, IT service providers, data storage, hosting and server providers, or analytics platforms</li>
        ...
        <h4 id="10">10. INTERNATIONAL TRANSFERS OF PERSONAL INFORMATION</h4>
        <p>
        ...
        <h4 id="11">11. YOUR RIGHTS AND CONTROLLING YOUR PERSONAL INFORMATION</h4>
        <p>
        ...
        <h4 id="13">13. LIMITS OF OUR POLICY</h4>
        <p>
        ...
        <h3 id="14">14. CHANGES TO THIS POLICY</h3>
        <p>
