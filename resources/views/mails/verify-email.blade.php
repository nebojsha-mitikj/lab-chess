                                ...
                                <td style="padding:0 35px;">
                                    ...
                                    <table border="0" align="center" cellpadding="0" cellspacing="0" style="text-align: center;">
                                        <tr style="text-align: center">
                                            <a href="{{$url}}" style="background-color: #3D96F2;text-decoration:none !important; font-weight:500; margin:35px auto; color:#fff;font-size:14px;padding:10px 24px;display:inline-block; text-align: center !important;">
