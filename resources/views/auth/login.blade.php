<x-guest-layout>
    <div class="flex flex-col justify-center items-center pt-2 pb-5 sm:pt-2 sm:pb-2 guest-height mt-8">
        ...
        <div class="w-full max-w-sm p-5 mt-1 mb-4 border rounded border-gray-200 shadow-md bg-white guest-card">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <button class="py-3 bg-primary hover:bg-primary-dark text-white no-select font-semibold mt-4 w-full">
                    Log In
                </button>

                <p class="text-center mt-3 text-gray-700">Don't have an account? <a href="{{route('register')}}" class="text-primary text-lg hover:underline">Sign Up</a></p>
            </form>
