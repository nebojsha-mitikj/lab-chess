...
class PasswordTest extends TestCase
{
    ...
    public function test_update_password_screen_can_be_rendered_when_authenticated()
    {
        $this->seed();
    ...
    public function test_update_password_screen_cannot_be_rendered_when_unauthenticated()
    {
        $response = $this->get('/settings/password');
